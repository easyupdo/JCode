...
public:
    void setCmd800();
    void setCmd801C(QByteArray voiceRecordText);
    void setCmd802C();
...
//    int getDecodePcmDataLength(int);
    QString getCustomMD5Result(QString Text, uint4 key[]);
    QString getStandardMD5Result(QString Text);

//signals:
//    void toRealTimeFormForSocketOK();

signals:
    void toMainShowMD5(QString s_md5,int index);

...
#ifndef SOURCE_COMMON_WORK_UNIT_H_
#define SOURCE_COMMON_WORK_UNIT_H_
...
public:
    /**
     * \brief Shared Pointer to an WorkUnit object.
     **/
    typedef std::shared_ptr<WorkUnit> Ptr;
...
#endif /* SOURCE_COMMON_WORK_UNIT_H_ */
